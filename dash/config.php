            ...
            <form class="user">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control">
                        <label for="entryForm_terms" data-localize="config_terms"></label>
                        <input type="text" class="form-control" id="entryForm_terms" aria-describedby="terms">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" value="1" id="videoScreen_pipEnabled">
                        <label class="custom-control-label" for="videoScreen_pipEnabled" data-localize="config_pip"></label>
                    </div>
                    <div class="custom-control custom-checkbox">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" value="1" id="serverSide_videoLogs">
                        <label class="custom-control-label" for="serverSide_videoLogs" data-localize="config_videologs"></label>
                    </div>

                </div>
                <hr>
                <div class="form-group">
                    <h6 data-localize="config_social"></h6>

                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" value="1" id="social_enabled">
                        <label class="custom-control-label" for="social_enabled" data-localize="config_enabled"></label>
                    </div>

                    <div class="custom-control">
                        <label for="social_facebookId" data-localize="config_facebookId"></label>
                        <input type="text" class="form-control" id="social_facebookId" aria-describedby="social_facebookId">
                    </div>
                    <div class="custom-control">
                        <label for="social_googleId" data-localize="config_googleId"></label>
                        <input type="text" class="form-control" id="social_googleId" aria-describedby="social_googleId">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <hr>
                    <div class="custom-control">
                        <label for="transcribe_direction" data-localize="config_direction"></label>
                ...
                <?php } else { ?>
                <input type="hidden" id="iceServers">
                <input type="hidden" id="iceServers_requirePass">
                <?php } ?>
