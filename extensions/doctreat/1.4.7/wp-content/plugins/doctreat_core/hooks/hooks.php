				...
				if( !empty($user->roles[0]) && $user->roles[0] == 'seller' ){
					...
					if(!empty($redirect_id)){
						...
						if( function_exists('doctreat_get_search_page_uri') ){
							$profile_page  = doctreat_get_search_page_uri('doctors');
						}
				...
				<div class="dc-modalcontent modal-content">	
					<div class="dc-loginformholds">
						<div class="dc-loginheader">
							...
							<a href="javascript:;" class="dc-closebtn close dc-close" data-dismiss="modal" aria-label="<?php esc_attr_e('Close','doctreat');?>"><i class="fa fa-times"></i></a>
						</div>
