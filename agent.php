...
<body>
    <div class="divGenerate">
        <table style="width: 500px;">
            <tr>
                <td>Date: </td>
                <td><input autocomplete="off" type="text" id="datetime" /></td>
                <td>Duration: </td>
            ...
            <tr>
                <td>Agent Name: </td>
                <td><input autocomplete="off" type="text" id="names" /></td>
                <td>Agent Short URL: </td>
                <td><input autocomplete="off" type="text" id="shortagent" /></td>
            </tr>
            <tr>
                <td>Visitor Name: </td>
                <td><input autocomplete="off" type="text" id="visitorName" /></td>
                <td>Visitor Short URL: </td>
                <td><input autocomplete="off" type="text" id="shortvisitor" /></td>
            </tr>
            <tr>
                <td>Room: </td>
                <td><input autocomplete="off" type="text" id="roomName" /></td>
                <td>Password: </td>
                <td><input autocomplete="new-password" type="password" id="roomPass" /></td>
            </tr>
            <tr>
                <td colspan="4">
    ...
    <script src="/js/loader.v2.js" data-source_path="/"></script>
</body>
